...
public abstract class DatabaseMessageSourceBase extends AbstractMessageSource implements ResourceLoaderAware{
	 ...
	 */
	protected abstract Messages extractI18NData(ResultSet rs) throws SQLException, DataAccessException;
